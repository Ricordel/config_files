...
syn region  factorPredicate     start=/\<PREDICATE:\>/ end=/\<;\>/
...
syn match   factorModifier  "IN:"
syn match   factorModifier  "USE:"
syn match   factorModifier  "UNUSE:"

syn match   factorModifier  "CHAR:"

syn match   factorModifier  "USING:"
syn match   factorModifier  "QUALIFIED:"
syn match   factorModifier  "QUALIFIED-WITH:"
syn match   factorModifier  "EXCLUDE:"
syn match   factorModifier  "FROM:"
syn match   factorModifier  "RENAME:"
syn match   factorModifier  "SINGLETONS:"
syn match   factorModifier  "SYMBOL:"
syn match   factorModifier  "SYMBOLS:"
syn match   factorModifier  "CONSTRUCTOR:"
syn match   factorModifier  "INTERSECTION:"
syn match   factorModifier  "TUPLE:"
syn match   factorModifier  "ERROR:"
syn match   factorModifier  "UNION:"
syn match   factorModifier  "UNION-STRUCT:"
syn match   factorModifier  "PREDICATE:"

syn match   factorModifier  "CONSTANT:"
syn match   factorModifier  "ALIAS:"
syn match   factorModifier  "SINGLETON:"
syn match   factorModifier  "POSTPONE:"
syn match   factorModifier  "DEFER:"
syn match   factorModifier  "FORGET:"
syn match   factorModifier  "MIXIN:"
syn match   factorModifier  "INSTANCE:"
syn match   factorModifier  "HOOK:"
syn match   factorModifier  "MAIN:"
syn match   factorModifier  "C:"
...
if version >= 508 || !exists("did_factor_syn_inits")
    ...
    HiLink factorDefnDelims             Function
    HiLink factorMethodDelims           Function
    HiLink factorGenericDelims          Function
    HiLink factorGenericNDelims         Function
    ...
    hi link factorModifier		Special

    if &bg == "dark"
        hi   hlLevel0 ctermfg=197         cterm=bold guifg=red1 
        hi   hlLevel1 ctermfg=214         cterm=bold guifg=orange1
        hi   hlLevel2 ctermfg=green       cterm=bold guifg=yellow1
        hi   hlLevel3 ctermfg=cyan        cterm=bold guifg=greenyellow
        hi   hlLevel4 ctermfg=magenta     cterm=bold guifg=green1
        hi   hlLevel5 ctermfg=red         cterm=bold guifg=springgreen1
        hi   hlLevel6 ctermfg=yellow      cterm=bold guifg=cyan1
        hi   hlLevel7 ctermfg=green       cterm=bold guifg=slateblue1
        hi   hlLevel8 ctermfg=cyan        cterm=bold guifg=magenta1
        hi   hlLevel9 ctermfg=magenta     cterm=bold guifg=purple1
    else
        hi   hlLevel0 ctermfg=197         cterm=bold guifg=red3
        hi   hlLevel1 ctermfg=darkyellow  cterm=bold guifg=orangered3
        hi   hlLevel2 ctermfg=darkgreen   cterm=bold guifg=orange2
        hi   hlLevel3 ctermfg=blue        cterm=bold guifg=yellow3
        hi   hlLevel4 ctermfg=darkmagenta cterm=bold guifg=olivedrab4
        hi   hlLevel5 ctermfg=red         cterm=bold guifg=green4
        hi   hlLevel6 ctermfg=darkyellow  cterm=bold guifg=paleturquoise3
        hi   hlLevel7 ctermfg=darkgreen   cterm=bold guifg=deepskyblue4
        hi   hlLevel8 ctermfg=blue        cterm=bold guifg=darkslateblue
        hi   hlLevel9 ctermfg=darkmagenta cterm=bold guifg=darkviolet
    endif
