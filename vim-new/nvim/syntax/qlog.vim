...
syn match hostid       "|[^|]*" contained nextgroup=threadid contains=Warn,QError,Info,Debug
syn match threadid     "|[^|]*" contained nextgroup=msgnature contains=Warn,QError,Info,Debug
syn match msgnature    "|[^|]*" contained nextgroup=loglocation contains=Warn,QError,Info,Debug
syn match loglocation  "|[^|]*" contained nextgroup=logcontent contains=Warn,QError,Info,Debug
