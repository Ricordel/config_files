...
syn match hsReturn    "\<\(return\|fail\)\>"
...
" Partie trouvée dans un autre fichier de syntaxe pour les fonctions définies
" soi-même :
...
if version >= 508 || !exists("did_hs_syntax_inits")
  ...
  hi link hsReturn		Statement
  hi link hsDelimiter		Delimiter

  hi link hs_hlFunctionName    hsUserFunction
  hi link hs_HighliteInfixFunctionName hsUserFunction
  hi link hs_HlInfixOp       hsUserFunction
  hi link hs_OpFunctionName  hsUserFunction
