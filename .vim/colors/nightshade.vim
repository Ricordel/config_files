...
hi Normal		guifg=#e0e0e0 guibg=#000000						ctermfg=lightgray ctermbg=black
...
hi Question			guifg=green gui=none ctermfg=darkgreen cterm=none
...
hi Constant	guifg=#ff58b3 gui=bold ctermfg=red
hi String	guifg=Orange gui=bold ctermfg=white
hi Special	guifg=Orange gui=none ctermfg=lightgreen
hi Identifier	guifg=red gui=none ctermfg=blue
hi Statement	guifg=blue gui=bold ctermfg=Blue
hi PreProc	guifg=green3 gui=none ctermfg=darkGreen
hi type		guifg=purple gui=none ctermfg=darkyellow
...
hi Function     guifg=green gui=bold ctermfg=darkyellow
...
hi Keyword      guifg=red ctermfg=lightgreen
