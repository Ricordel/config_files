...
if &t_Co > 255
   ...
   hi MatchParen      ctermfg=33  ctermbg=250 cterm=bold
   ...
   if exists("g:rehash256") && g:rehash256 == 1
       ...
       hi Conditional     ctermfg=70               cterm=bold
       ...
       " For a weird reason, this is in the syntax file, but does not
       " work unless put here too...
       hi def link pythonSelf Keyword
       hi Keyword         ctermfg=39               cterm=bold
