...
if exists("g:impact_transbg")
        ...
        hi Comment      ctermfg=Red guifg=DarkGray  ctermbg=none guibg=White cterm=bold gui=bold term=bold
        hi Constant     ctermfg=DarkCyan guifg=DarkCyan  ctermbg=none guibg=White
        hi Identifier   ctermfg=Cyan guifg=Cyan      ctermbg=none guibg=White
        ...
        hi Normal       ctermfg=LightGray guifg=LightGray ctermbg=Black guibg=White
